...
% Backpropagation
%Loop through examples from 1 to m
for t = 1:m,

  % Step1: performs Forwardpropagation
  a1 = [1 X(t,:)];
  z2 = a1 * Theta1';
  a2 = [1 sigmoid(z2)];
  z3 = a2 * Theta2';
  ...
  % Step2: sets up the error for last layer
  delta3 = a3 - y_new(t, :);

  % Step3: sets up the error for l=2 layer
...
% Step5: Obtain the (unregularized) gradient
Theta1_grad = (1/m) * Theta1_grad;
Theta2_grad = (1/m) * Theta2_grad;


%Implement regularization with gradients.
